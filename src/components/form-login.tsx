            ...
            <main>
                ...
                <form className='login-form' action={loginClientAction}>
                    ...
                    <div className='user-container'>
                        <input type="text" id='user-input' name="email" placeholder='Digite seu Email' required/>
                        <FontAwesomeIcon icon={faEnvelope} id='user-icon' />
                    </div>

                    <div className='psw-container'>
                        <input type="password" id='psw-input' name="password" placeholder='Digite sua Senha' required/>
